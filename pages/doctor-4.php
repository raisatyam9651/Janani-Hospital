        ...
        <div>
          <div class="profile-card" data-reveal="up" data-reveal-on="mount">
            ...
            <div class="profile-card__body">
              <h1 class="profile-card__name">Dr. Suresh Babu</h1>
              <p class="profile-card__specialty">Orthopedic Surgeon</p>
              <div class="profile-card__stats">
                <div class="profile-stat">
                  <p class="profile-stat__label">Experience</p>
                  <p class="profile-stat__value">12+ Years</p>
                </div>
                <div class="profile-stat">
        ...
        <div class="profile-layout__main">
          <div class="profile-panel" data-reveal="right" data-reveal-on="mount" data-reveal-delay="100">
            ...
            <p class="profile-panel__lede">
              Specialist in joint replacement and sports medicine. Dr. Suresh Babu is one of the leading specialists in Orthopedics with
            ...
            <div class="profile-cols">
              <div>
                ...
                <ul>
                  <li><svg class="icon"><use href="#i-award"></use></svg> MBBS, MS (Ortho)</li>
